...
import { SNS_HISTORY_REQUEST } from "../../../reducers/company";

const Logo = ({}) => {
  const { st_loadMyInfoDone, me } = useSelector((state) => state.user);
  const { historys } = useSelector((state) => state.company);
  ...
  return (
    <AdminLayout>
      ...
      <Wrapper margin={`10px 0px 0px 0px`}>
        <GuideUl>
          <GuideLi>
            SNS정보를 변경하거나 우선순위를 변경한 이력을 확인할 수 있습니다.
          </GuideLi>
          <GuideLi isImpo={true}>
