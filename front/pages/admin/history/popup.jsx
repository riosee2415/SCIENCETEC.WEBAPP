...
import { POPUP_HISTORY_REQUEST } from "../../../reducers/popup";

const MainBannerHistory = ({}) => {
  const { st_loadMyInfoDone, me } = useSelector((state) => state.user);
  const { history } = useSelector((state) => state.popup);
  ...
  return (
    <AdminLayout>
      ...
      <Wrapper margin={`10px 0px 0px 0px`}>
        <GuideUl>
          <GuideLi>팝업 제어이력을 확인할 수 있습니다.</GuideLi>
          <GuideLi isImpo={true}>
