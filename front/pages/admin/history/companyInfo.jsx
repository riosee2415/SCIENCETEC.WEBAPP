...
import { COMPANYINFO_HISTORY_REQUEST } from "../../../reducers/company";
...
const Logo = ({}) => {
  ...
  useEffect(() => {
    dispatch({
      type: COMPANYINFO_HISTORY_REQUEST,
      data: {
        datePick,
      },
    });
    ...
    <AdminLayout>
      ...
      <Wrapper padding={`0px 50px`}>
        <Table
          ...
          rowKey="id"
          columns={col}
          dataSource={companyHistory ? companyHistory : []}
          size="small"
        />
      </Wrapper>
    </AdminLayout>
